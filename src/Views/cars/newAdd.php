<form method="POST" action="/cars/store/" enctype="multipart/form-data" class="row g-3 vstack gap-2 col-md-6 mx-auto bg-light border border-primary rounded p-2 mb-2 mt-4">
    <div class="row">  
    <div class="col-md-4">
